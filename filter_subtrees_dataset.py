...
#function to return the fractions for a list of genes.
#Input is a list of genes
#Output is a dictionary with each key a gene name with an attribute fraction
...
#Compare subtrees with each other. If two subtrees contain the exact same high fraction genes, keep the largest.
